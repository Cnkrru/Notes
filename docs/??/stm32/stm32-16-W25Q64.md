...
void W25Q64_WaitBusy(void)
{
    ...
    do { Status = SoftSPI_Transfer(0xFF); } while (Status & 0x01);
    SoftSPI_W_SS(1);
}
...
void W25Q64_PageProgram(uint32_t Address, uint8_t *DataArray, uint16_t Count)
{
    ...
    while (Count--) { SoftSPI_Transfer(*DataArray++); }
    SoftSPI_W_SS(1);
    W25Q64_WaitBusy();
}
...
void W25Q64_ReadData(uint32_t Address, uint8_t *DataArray, uint32_t Count)
{
    ...
    SoftSPI_Transfer((Address >> 8) & 0xFF);
    SoftSPI_Transfer(Address & 0xFF);
    while (Count--) { *DataArray++ = SoftSPI_Transfer(0xFF); }
    SoftSPI_W_SS(1);
}
...
void W25Q64_HardWaitBusy(void)
{
    ...
    do { Status = HardSPI_Transfer(0xFF); } while (Status & 0x01);
    HardSPI_W_SS(1);
}
...
void W25Q64_HardPageProgram(uint32_t Address, uint8_t *DataArray, uint16_t Count)
{
    ...
    while (Count--) { HardSPI_Transfer(*DataArray++); }
    HardSPI_W_SS(1);
    W25Q64_HardWaitBusy();
}
...
void W25Q64_HardReadData(uint32_t Address, uint8_t *DataArray, uint32_t Count)
{
    ...
    HardSPI_Transfer((Address >> 8) & 0xFF);
    HardSPI_Transfer(Address & 0xFF);
    while (Count--) { *DataArray++ = HardSPI_Transfer(0xFF); }
    HardSPI_W_SS(1);
}
