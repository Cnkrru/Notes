...
3. 介质磁化
    - 介质内有磁偶极子
        - 磁偶极子原本的方向是杂乱无章，经过磁化，方向趋于一致，产生磁化电流
            - 磁化电流的电流密度为 Jm
        - 磁化强度 $$M = \frac{P_m}{V}$$
            - 关联式：$$\oint M\cdot dl = Jm\cdot S$$（即磁化电流 $$I_m = \oint M\cdot dl$$）
...
1. 磁场能量
    ...
    - 多线圈：$$W = \frac{1}{2}L_1I_1^2 + \frac{1}{2}L_2I_2^2 + M\cdot I_1I_2$$
